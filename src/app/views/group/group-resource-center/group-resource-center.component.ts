...
@Component({
  ...
  selector: 'app-group-resource-center',
  templateUrl: './group-resource-center.component.html',
  styleUrls: ['./group-resource-center.component.scss']
})
export class GroupResourceCenterComponent {
